public class Worker {
	...
	// assigning plant a specific thread
	...
	// wrote everything in ProcessOrange except the call to orange.
	// Process orange. Plant[1] Worker[2] & Plant[2] Worker[2] will Squeeze the
	// Orange
